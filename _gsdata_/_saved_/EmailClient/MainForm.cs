...
namespace EmailClient
{
    public partial class MainForm : Form
    {
        ...
        public List<ListViewItem> GetAllListViewItems(POP3Class popClient)
        {
            ...
            DateTime dt_MAX = DateTime.ParseExact(s_dt, "yyyy/M/d", System.Globalization.CultureInfo.CurrentCulture);
            string s_m_dt = m_hListViewItems[0].SubItems[4].Text.Split(' ')[0];
            Console.WriteLine(s_m_dt);
            DateTime dt_Mail_MAX = DateTime.ParseExact(s_m_dt, "yyyy/M/d", System.Globalization.CultureInfo.CurrentCulture);
            dt_Mail_MAX = dt_Mail_MAX.AddDays(-10);
